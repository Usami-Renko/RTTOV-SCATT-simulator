...
def get_output_filename(fobs_dic, model_filename):
	...
	filename_segments.append(model_filename.strip("modelvar")[:-2])
...
if __name__ == "__main__":
	...
	# [C]. fixed params
	Bin_filename 	= "rttovscatt_fwd_zvertinho_interp.exe"
	...
	# [D]. model params
	# mdl_ext 		= [132, 142, 15, 25]
	# mdl_ext 		= [70,  145, 10, 60.1] # 10km
	# mdl_ext 		= [102, 135, 17, 50] # 3km
	# mdl_ext 		= [127, 128.2, 22, 23.2] # zvertinho test
	mdl_ext 		= [125.2, 131.2, 20.2, 26.2] # Danas test
	mdl_res 		= 0.03
	three_km  		= True
	# if changed, rttov_scatt.mod have to be changed, too
	mdl_nlevels 	= 50  # include the underearth virtual level

	model_ini_dirs  = ['2019071800']
