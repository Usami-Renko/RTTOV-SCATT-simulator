PROGRAM rttovscatt_fwd_padding_vertinho_interp_main
...
#include "rttov_scatt_vertinho.interface"
...
!---------------[C]  levels field-----------------------
  ...
  ! --------------------------------------------------------------------------
  IF (nthreads <= 1) THEN
    WRITE(*,*) "before enter rttov_scatt_vertinho"
    CALL rttov_scatt_vertinho ( &
    ...
    WRITE(*,*) "after enter rttov_scatt_vertinho"
  ELSE
...
END PROGRAM rttovscatt_fwd_padding_vertinho_interp_main
