...
'''
@Description: plot single scattering properties of contious parameter snowflake
@Author: Hejun Xie
@Date: 2020-03-28 11:48:31
@LastEditors: Hejun Xie
@LastEditTime: 2020-04-29 10:31:47
'''
...
yml_file = './config/plot_continuous_parameter_SSP.yml'
...
if __name__ == "__main__":
    ...
    # plot settings
    SSPindices      = range(len(DATA_NAMES))
