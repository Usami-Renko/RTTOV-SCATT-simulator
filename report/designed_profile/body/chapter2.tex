...
Apply the above definition to the \oops{extinction loss term}, obviously we find extinction loss term is also a intrinsic term:
...
increases the scattering source term significantly, but leave the intrinsic terms unchanged.
