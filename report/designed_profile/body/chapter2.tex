...
\caption{18.7GHZ H brightness temperature over high and low adjusting factor between $10^{-2}$ and $10^{1}$ for four vertical 
inhomogeneity schemes of ice particle shapes.}
\label{fig:MWRI2BT}
\end{figure}
...
for snow water mixing ratio of $6 \times 10^{-3}$ kg/kg. The gap of bulk extinction the two shapes get wider with increasing frequency,
...
see Fig. \ref{fig:against_freq_2column}). Just mention that the homogeneous scattering is getting invalid with increasing frequecy when bulk asymmetry
hits the threshold of 0.1. Dendrite has a higher bulk asymmetry where the mixing ratio and ambient temperature is high, vice versa
(also justified by Fig. \ref{fig:against_freq_2column}).
\end{itemize}
