...
\caption{Intermediate radiative transfer variables of standard hydrometeor profile: 
...
\caption{Total bulk scattering properties accounting for hydrometeors and gas.}
\label{fig:MWRIABSP}
\end{figure}
...
\caption{89.0GHZ brightness temperature aganist high and low adjusting factor between $10^{-2}$ and $10^{1}$ for four vertical 
inhomogeneity schemes of ice particle shapes.}
\label{fig:MWRI5BT}
\end{figure}
...
\caption{Observed and simulated over-ocean brightness temperatures on 31 August 2018 in the region of Typhoon Feiyan at channel 89.0GHZ of MWRI.
Simulations are generated by GRAPES RMFS forecast (10km operational run 2018083100z +3h). The satellite FY-3D overpassed the
tropical cyclone at 03:32 UTC}
